...
for n = [6,7]
    ...
    write1ByteTxRx(port_num, PROTOCOL_VERSION, n, 11, 16);
...
while(isOn ~=1)
    ...
    if button(joy, 7) == 1
        ...
        write4ByteTxRx(port_num, PROTOCOL_VERSION, 9, ADDR_PRO_GOAL_POSITION, vertical);
    end
    ...
    if button(joy, 8) == 1
        ...
        write4ByteTxRx(port_num, PROTOCOL_VERSION, 9, ADDR_PRO_GOAL_POSITION, horizontal);
    end
